const projectList = [
  ...
  },
  {
    ...
    imgUrl: require("./project-exercisetracker-img.png").default,
    gitHubUrl: "https://github.com/naruebes-dearw/exercisetracker-project",
    projectUrl: "https://exercisetrackerproject.herokuapp.com/",
    projectDescption: "Exercise tracker website was created by MERN stack that can create, edit and delete exercise infomation.",
    technology: "ReactJS, NodeJS, MongoDB, Express, React-Bootstrap, React-Router, Heroku",
  },
  {
    id: 3,
    title: "Login System",
    imgUrl: require("./project-loginsystem-img.png").default,
    gitHubUrl: "https://github.com/naruebes-dearw/nodejs-login-system",
    projectUrl: "https://loginsystemproject.herokuapp.com/",
    projectDescption: "Login System was created by NodeJS. Using the cookie session to store login information on the server side so that it can be accessed automatically without having to login again.",
    technology: "NodeJS, MongoDB, Express, PassportJS, Cookie-Session, Heroku",
  },
  {
    id: 4,
